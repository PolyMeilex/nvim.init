local NuiText = require("renui.text")

---@class RenuiLine
---@field _texts RenuiText[]
local Line = {}
Line.__index = Line

---@param texts? RenuiText[]
function Line:new(texts)
  return setmetatable({
    _texts = texts or {},
  }, self)
end
